...
/**
 * 에러 타입에 따른 메시지 반환
 * @param {string} errorType - 에러 타입 (ERROR_MESSAGES의 키)
 * @param {string} defaultMessage - 기본 메시지 (선택)
 * @returns {string} 에러 메시지
 */
export function getErrorByType(errorType, defaultMessage = ERROR_MESSAGES.GENERIC) {
