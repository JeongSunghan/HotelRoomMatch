...
const ROOM_MAPPING = {
    single: {
        ...
        M: [1101, 1102, 1103, 1104, 1105, 1106, 1107, 1109, 1110, 1111, 1112, 1113, 1114, 1115, 1117],
    },
    double: {
        F: [1014, 1015, 1017, 1018, 1019, 1020, 1021, 1022, 1023, 1024, 1026],
        M: [901, 902, 903, 904, 905, 906, 907, 908, 909, 910, 911, 912, 913, 914, 915, 917, 918, 919, 920],
    },
};
