...
export default function DeadlineSettings() {
    ...
    useEffect(() => {
        const unsubscribe = subscribeToSettings((data: Settings | null) => {
            setSettings(data);
            if (data) {
    ...
    const formatToISO = (localDateTime: string): string | null => {
    ...
    const formatDeadlineDisplay = (): string => {
