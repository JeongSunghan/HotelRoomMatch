...
export default function UserManagementTab() {
    ...
    // 유저 목록 실시간 구독
    useEffect(() => {
        const unsubscribe = subscribeToAllUsers((allUsers: User[]) => {
            setUsers(allUsers);
        });
    ...
    // 성별 라벨
    const genderLabel = (gender: Gender): string => gender === 'M' ? '👨 남성' : '👩 여성';
                        ...
                        <div className="space-y-4">
                                ...
                                <div className="flex gap-4">
                                    <label className="flex items-center gap-2">
                                        <input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setEditForm({ ...editForm, gender: e.target.value as Gender })}
                                        />
                                        <span>👨 남성</span>
                                    </label>
                                    <label className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <input
                                    type="number"
                                    value={editForm.age}
                                    onChange={(e: ChangeEvent<HTMLInputElement>) => setEditForm({ ...editForm, age: e.target.value })}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-lg"
                                    min="0"
                                    max="100"
                                />
